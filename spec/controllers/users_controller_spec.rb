...
#        get :new
#        response.should have_selector("input[password='user[password_confirmation]'][type='password']")
#      end
  ...
  describe "DELETE 'destroy'" do
    ...
    before(:each) do
      @user = Factory(:user)
      @second = Factory(:user, :name => "Bob", :email => "another@example.com", :admin => true)
    end
#
...
#    end
    ...
    describe "as an admin user" do
      ...
      describe "admins" do
        ...
        before(:each) do
          @second = Factory(:user, :name => "Bobby", :email => "another2@example.com", :admin => true)
          test_sign_in(@second)
        end

        it "should not be able delete themselves" do
          lambda do
